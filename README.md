...
Evidence-linked US large-load interconnection intelligence. Live site: https://tracker-energy.surge.sh/
...
- `.github/workflows/nightly.yml` - nightly refresh, validation, artifact archive, commit and optional Surge deploy.
